...
//  DONE (7) Instantiate a static UriMatcher using the buildUriMatcher method
    ...
    public static UriMatcher buildUriMatcher() {
        UriMatcher matchedUri = new UriMatcher(UriMatcher.NO_MATCH);

        matchedUri.addURI(WeatherContract.CONTENT_AUTHORITY,WeatherContract.PATH_WEATHER,CODE_WEATHER);
        matchedUri.addURI(WeatherContract.CONTENT_AUTHORITY,WeatherContract.PATH_WEATHER+"/#",CODE_WEATHER_WITH_DATE);
