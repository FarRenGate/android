...
public class ChildActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intentWhichCalled = getIntent();

        if (intentWhichCalled.hasExtra(Intent.EXTRA_TEXT)) {
           String receivedText = intentWhichCalled.getStringExtra(Intent.EXTRA_TEXT);
